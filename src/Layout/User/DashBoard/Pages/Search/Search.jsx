...
//                 </div>
//                 <div className="flex items-center sm:mt-1 md:mt-2">
//                   <img className="h-[12px] xs:h-[15px] sm:h-[20px] mr-2" src="Svg/Heart.svg" alt="Heart" />
//                   <span className="lato-regular text-[9px] xs:text-[10px] sm:text-[13px] md:text-sm">{Likes}</span>
//                 </div>
//               </div>
//               <div className="lato-regular sm:ml-4 lg:ml-10">
//                 <div>
//                   <span className="poppins-bold text-[9px] xs:text-[10px] sm:text-[13px] md:text-sm">{ER}</span>
//                   <span className="ml-1 md:text-sm sm:text-[13px] text-[9px] xs:text-[10px]">ER</span>
//                 </div>
//                 <div className="flex items-center sm:mt-1 md:mt-2">
//                   <img className="h-[12px] xs:h-[15px] sm:h-[20px] mr-2" src="Svg/Chat.svg" alt="Comments" />
//                   <span className="lato-regular text-[9px] xs:text-[10px] sm:text-[13px] md:text-sm">{Comments}</span>
//                 </div>
//               </div>
//             </div>

//             <div className="grid grid-cols-2 sm:mt-5">
//               <a href={Instagram} target="_blank" rel="noopener noreferrer" className="text-[9px] xs:text-[10px] sm:text-[13px] md:text-sm text-blue-500">Visit Instagram</a>
//             </div>

//             <div className="mt-2">
//               <p className="lato-regular text-[9px] xs:text-[10px] sm:text-[13px] md:text-sm">{Bio}</p>
//             </div>
//           </div>
//         </div>
