...
const InfluencerProfile = ({ setShowInfluencerProfile }) => {
  ...
  return (
    <>
      <div
        className=" flex justify-end  w-[300px] xs:w-[500px] gap-x sm:w-[640px] md:w-[740px] lg:w-[800px] mx-auto pt-3 pb-3 cursor-pointer"
        onClick={() => {
      ...
      <div className=" w-[300px] xs:w-[550px] sm:w-[700px]  mdm:w-[820px] lg:w-[900px] mx-auto">
        <div className="bg-white w-full   mt-10 rounded-3xl  mx-auto">
          <div className="px-5 py-3 flex flex-col">
            <p className="lato-bold   text-[9px] xs:text-[10px] sm:text-[13px] md:text-[11px]">
              OverView
            </p>

            <div className="mt-6 ">
              <div className="mt-2 grid xs:grid-cols-2 xs:grid-rows-3 md:grid-cols-3 md:grid-rows-2  justify-center items-center  gap-y-5 ">
                <Card
      ...
      <div className="  border-2">
        ...
        <div className="bg-white grid grid-cols-12 OverViewBox2  w-[300px] xs:w-[500px] gap-x sm:w-[640px] md:w-[740px] lg:w-[800px] p-2 border-2 mx-auto  rounded-xl">
          ...
          <div className="col-span-7 mt-4 ml-2 ">
            ...
            <p className="poppins-regular text-[9px]  sm:text-[13px] md:text-[11px] mt-2  xs:text-[10px]  ">
              Embrace the Ashin Aura: Where Tradition Meets Trend.
            </p>
          ...
          <div className="col-span-3 justify-self-center  mt-4">
            <div className="flex items-center  gap-x-1">
              <img
                ...
                className="Avatar size-[12px] xs:size-[15px] sm:h-[16px]"
                alt=""
              />
              <p className="text-[9px] lato-light  xs:text-[10px] sm:text-[11px]">
                {" "}
                2.3K Followers
              </p>
            </div>
            ...
            <div className=" hidden  xs:flex justify-center gap-x-3 mt-2">
              <div className=" flex items-center gap-x-1 ">
                <img
                  src="/Svg/Heart.svg"
                  className="Avatar   xs:size-[15px] sm:h-[16px]"
                  alt=""
                />
                <p className="text-[9px] lato-light  xs:text-[10px] sm:text-[11px]">
                  {" "}
    ...
    <>
      {items.map((item, index) => (
        ...
        >
          <li
            className={`${
              isActive === index || isHover === index ? "text-primary" : ""
            } list-none`}
          >
            <p className="poppins-bold text-[9px] xs:text-[10px] sm:text-[13px] md:text-[11px] ">
              {item}
            ...
            {isActive === index && (
              <motion.div
                layoutId="1"
                className="absolute w-full bg-white h-full top-0 left-0 p-2 rounded-full -z-10"
              ></motion.div>
            )}
          </li>
        </div>
        ...
        <div className="bg-white mx-auto  mt-10 rounded-3xl">
          <div className="px-5 py-5 flex flex-col">
            ...
            <div className="mt-6 ">
              ...
              <p className="lato-regular mt-12 ml-7">
      ...
      <div className=" text-[10px] xs:px-5 w-[200px] h-[200px] mdm:w-[200px] mdm:h-[200px] bg-white rounded-2xl flex  flex-col  OverViewBox1 justify-self-center">
        <div className=" px-3 py-1   mdm:py-2 lato-regular  mt-2">
          ...
          <div className="flex flex-col items-center ">
            ...
            <p className="lato-regular text-[10px] text-black/50">
              @rizwansabir
            </p>
            <p className="lato-regular  mt-5 text-[14px] lato-bold text-green-500">
              3 Collaboration
            </p>
          </div>
        </div>
